...
class Followers_Fragment : Fragment(R.layout.fragment_follow) {
    private var _binding: FragmentFollowBinding? = null
    private val binding get() = _binding!!
    private lateinit var viewModel: FollowersAccountModel
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        adapter.setOnItemClickCallback(object: AccountAdapter.OnItemClickCallback{
            override fun onItemClicked(data: Account) {
                val intent = Intent(this@Followers_Fragment.requireContext(), DetailAccountActivity::class.java)
        ...
        viewModel = ViewModelProvider(this, ViewModelProvider.NewInstanceFactory()).get(
            FollowersAccountModel::class.java
        )
